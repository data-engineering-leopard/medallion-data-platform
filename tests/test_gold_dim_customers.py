...
def spark():
    return SparkSession.builder \
        .master("local[*]") \
        .appName("test_gold_dim_customers") \
        .getOrCreate()
...
class TestRunDimCustomers:
    ...
    def test_run_dim_customers_creates_output(self, spark, tmp_path,
    ...
    def test_run_dim_customers_output_readable(self, spark, tmp_path,
                                                silver_customers_schema):
